...
# GET-APIGateway-REST-Workshop

This a Workshop to understand the funcionality of the AWS APIGateway integration with AWS Lambda using the HTTP GET Method
